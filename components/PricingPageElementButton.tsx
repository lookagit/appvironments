const PricingPageElementButton = () => {
    return(
            <div className="flex flex-col justify-center items-center w-[718px] h-[620px] bg-purple-dark mt-20 mb-20">
...
export default PricingPageElementButton