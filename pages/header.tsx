...
function Header() {
  return (
    <div class="grid content-center space-y-12 h-20 w-full, bg-indigo-900">
    <div class="flex h-4 w-full justify-center items-center space-x-7 text-sm text-zinc-100">
        <div class="flex justify-center h-8">
            <img src="https://i.ibb.co/vHkHTqw/logo-5.png" class="max-w-full h-auto" alt="header-logo"></img>
        </div>        
        {
